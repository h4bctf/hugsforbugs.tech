      ...
      <AnimatePresence>
        ...
        >
	      ...
	      <div className="w-full  h-5/6 grid grid-cols-1 justify-items-center gap-y-20 sm:grid-rows-2 sm:grid-cols-3 ">
		     <Profile githubLink="https://github.com/MrsMalware" name="MrsMalware"  src="https://cdn.discordapp.com/attachments/810603326626201604/950756488023015484/IMG_1413.jpg"/>
		     ...
		     <Profile githubLink="https://github.com/MrsMalware" name="Fade" src="https://cdn.discordapp.com/attachments/949990378323468329/949991760535384074/uzui.png"/>
		      ...
		      <Profile githubLink="https://github.com/Hartaj-Singh-Dev" name="Hartaj Singh" src="https://cdn.discordapp.com/attachments/930294296886788166/950771365861031946/My_croped_pic.png"/>
		     <Profile githubLink="https://github.com/MrsMalware" name="abhishekydv" src="https://cdn.discordapp.com/attachments/810603326626201604/950284402796142624/1791953.png  "/>
	      </div> 
          </section>
