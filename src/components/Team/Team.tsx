    ...
    <>
      <AnimatePresence>
        <motion.div
          ...
          exit={{ opacity: 0 }}
        >
          <section className="w-full h-[370vh] sm:h-[170vh]  flex flex-col  bg-[#191a27]">
	      ...
	      <div className="w-full  h-5/6 grid grid-cols-1 justify-items-center gap-y-20 sm:mt-4 sm:grid-rows-2 sm:grid-cols-3 ">
		     ...
		     <Profile description="Web and RE" githubLink="https://github.com/casmpy" name="3xploiter" src="https://cdn.discordapp.com/avatars/706545436831514647/f0e5a8e306034c2b7d54e62675019291.webp?size=240" />
